(function ($) {
	$(document).ready(function () {
		...
		// Bestimme das Bild basierend auf der Uhrzeit
		if (hour >= 6 && hour < 11) {
			// Morgen: 06:00–11:00 Uhr
			imageUrl = 'images/banner_morgens.jpg';  // Bild für Morgen
		} else if (hour >= 11 && hour < 18) {
			// Mittag: 11:00–18:00 Uhr
			imageUrl = 'images/banner_mittags.jpg';  // Bild für Mittag
		} else if (hour >= 18 && hour < 21) {
			// Abend: 18:00–21:00 Uhr
			imageUrl = 'images/banner_abends.jpg';  // Bild für Abend
		} else {
			// Nacht: 21:00–06:00 Uhr
			imageUrl = 'images/banner_nachts.jpg';  // Bild für Nacht
		}

		// Finde die .banner-image div und setze das Hintergrundbild
